...
$sql = "SELECT nomeanimal FROM animal WHERE codanimal =?";
$query = $pdo->prepare($sql);
$query->execute(array($codAnimal));
$listaNomeAnimal = $query->fetch(PDO::FETCH_ASSOC);
$nomeAnimal = $listaNomeAnimal['nomeanimal'];


$sql = "SELECT nome FROM veterinario WHERE cpf =?";
$query = $pdo->prepare($sql);
$query->execute(array($codVeterinario));
$listaNomeVeterinario = $query->fetch(PDO::FETCH_ASSOC);

$nomeVeterinario = $listaNomeVeterinario['nome'];
...
<head>
    ...
    <title>Remover Procedimento</title>
</head>
...
<body>
    ...
    <div class="container #fafafa grey lighten-5 z-depth-2">
        ...
        <div class="row">
            <form action="removerProcedimento.php" method="POST" class="formulario s12">
                        ...
                        <fieldset class="col offset-s1 s10" style="border: 2px solid black;">
                            ...
                            <div class="row">
                                <div class="input-field col offset-s3 s6">
                                   <input type="text" value="<?php echo $listaNomeAnimal['nomeanimal'] ?>" readonly>
                            ...
                            <div class="row">
                                <div class="input-field col offset-s3 s6">
                                   <input type="text" value="<?php echo $listaNomeVeterinario['nome'] ?>" readonly>
                            ...
                            <div class="row">
                                <div class="input-field col offset-s3 s3    ">
                                    <input name="dataProc" type="date" class="validate" value="<?php echo $dataProcedimento ?>" readonly>
                            ...
                            <table class="responsive-table col offset-s3 s6">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <label>
                                                <input class="with-gap" name="group1" type="radio" value="semDor" <?php if ($statusDor == "semDor") echo "checked"; ?> readonly/>
                                                <span>N/A</span>
                                            </label>
                            ...
                            <div class="row">
                                <div class="input-field col offset-s3 s6">
                                    <textarea id="textarea2" class="materialize-textarea readonly" maxlength="150" name="queixa" readonly><?php echo $queixa ?> </textarea>
                        ...
                        <fieldset class="col offset-s1 s10" style="border: 2px solid black;">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <textarea id="textarea1" class="materialize-textarea" name="procedimento" readonly> <?php echo $procedimento ?></textarea>
    ...
    <script>
        $(':radio:not(:checked)').attr('disabled', true);  //serve para desabilitar os radios
    </script>
